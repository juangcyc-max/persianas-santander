...
export async function generateBudgetPDF(customerData = {}, configuration = {}) {
  ...
  try {
    ...
    try{
      ...
      const qr = await QRCode.toDataURL(configUrl,{
        width:300
      })
    ...
    doc.text(
      "Persianas Santander • Calidad y confianza desde 1990",
      105,
      pageH-10,
      {align:"center"}
    )
    ...
    doc.text(
      "942 00 00 00  |  info@persianassantander.com",
      105,
      pageH-5,
      {align:"center"}
    )
    ...
    const fileName = `Presupuesto_${safeName}_${budgetNumber}.pdf`
