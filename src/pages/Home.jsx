        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-between gap-6">
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Horario</p>
                      <p className="text-gray-900 font-semibold text-sm leading-relaxed">
              ...
              {/* Imagen decorativa */}
              <div className="relative bg-gray-100 min-h-[240px] md:min-h-0 flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-8">
                  ...
                  <p className="text-gray-900 font-black text-lg">Santander</p>
                  <p className="text-gray-500 text-sm mt-1">Cantabria, España</p>
                </div>
              </div>
