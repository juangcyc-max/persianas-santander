...
function BlindTypeSelector({ blindType, onTypeChange }) {
  const isPano = blindType === 'laminada' || blindType === 'autoblocante'
    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <button
            onClick={() => {
              if (!isPano) onTypeChange('laminada')
              else onTypeChange(blindType === 'laminada' ? 'autoblocante' : 'laminada')
            }}
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {!isPano && (
                  <p className="text-xs text-gray-400">Laminado o autoblocante · Guías opcionales</p>
                )}

                {/* Toggle interno cuando está activo */}
                {isPano && (
