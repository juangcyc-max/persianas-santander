        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          {step === 0 && (
            <div className="space-y-4">
              ...
              {/* Google — acceso rápido como particular */}
              <button
                onClick={async () => {
                  ...
                  if (error) setErrors({ _global: 'No se pudo conectar con Google.' })
                }}
              ...
              >
                ...
                Registrarse con Google (cuenta particular)
              </button>

              <div className="flex items-center gap-3">
                <div className="flex-1 h-px bg-gray-200" />
                <span className="text-xs text-gray-400 font-medium">o elige tu tipo de cuenta</span>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
              <button
