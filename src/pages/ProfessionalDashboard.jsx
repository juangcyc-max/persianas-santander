...
function ProGroupCard({ items, onDeleteGroup, deleting }) {
  ...
  return (
    <div className="bg-white border-2 border-red-100 rounded-2xl p-4 hover:border-red-200 hover:shadow-sm transition-all flex flex-col gap-3">
      {/* Cabecera */}
      ...
      <div className="space-y-2">
        {items.map((c, i) => (
          <div key={c.id} className="flex items-center gap-2 text-xs">
            <span className="w-5 h-5 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center font-bold flex-shrink-0 text-[10px]">{i + 1}</span>
            <div className="flex-1 min-w-0">
      ...
      <div className="flex items-center justify-between pt-1 border-t border-gray-100">
        <span className="text-xs text-gray-400">Total grupo</span>
